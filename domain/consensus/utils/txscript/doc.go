/*
Package txscript implements the waglayla transaction script language.

This package provides data structures and functions to parse and execute
waglayla transaction scripts.
...
Typical waglayla scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend waglayla.
