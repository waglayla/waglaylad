...
func (UnimplementedPyrinwalletdServer) GetVersion(context.Context, *GetVersionRequest) (*GetVersionResponse, error) {
...
func _Pyrinwalletd_GetVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVersionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PyrinwalletdServer).GetVersion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var Pyrinwalletd_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Pyrinwalletd_GetVersion_Handler,
		},
	},
