...
func TestAddresses(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "waglayla:qq2u4dvcpvdcn0k03afx0lgqhlj06kk0ay8std3t87tuexlhq7m87e4n078d6",
		...
		{
			name:    "mainnet p2pk 2",
			addr:    "waglayla:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
		...
		{
			name:    "testnet p2pk",
			addr:    "waglaylatest:qph45l0y247vu078ktt3g0r0qefeqqqxrushmz4hlv2fjg6vfk3njk7pp4mh0",
		...
		// ECDSA P2PK tests.
		{
			...
			addr:    "waglayla:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2sm7yrlr4w",
		...
		{
			name:    "mainnet p2sh",
			addr:    "waglayla:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
		...
		{
			name:    "mainnet p2sh 2",
			addr:    "waglayla:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
		...
		{
			name:    "testnet p2sh",
			addr:    "waglaylatest:qpcs7zh3ufpv20eekyyy0f7u6fgz0mm9mf9s778qqx2zfvfmnxx86gjmfwhnh",
