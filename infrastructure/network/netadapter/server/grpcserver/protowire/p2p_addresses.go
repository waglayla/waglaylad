...
func (x *WaglayladMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "WaglayladMessage_Addresses is nil")
	}
...
func (x *WaglayladMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
