...
// installService attempts to install the waglaylad service. Typically this should
...
// removeService attempts to uninstall the waglaylad service. Typically this should
...
// startService attempts to Start the waglaylad service.
