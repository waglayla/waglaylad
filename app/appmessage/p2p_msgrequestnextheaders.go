...
// MsgRequestNextHeaders implements the Message interface and represents a waglayla
...
// NewMsgRequestNextHeaders returns a new waglayla RequestNextHeaders message that conforms to the
// Message interface.
