...
// MsgVersion implements the Message interface and represents a waglayla version
...
// NewMsgVersion returns a new waglayla version message that conforms to the
