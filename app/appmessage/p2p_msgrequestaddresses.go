...
// MsgRequestAddresses implements the Message interface and represents a waglayla
...
// NewMsgRequestAddresses returns a new waglayla RequestAddresses message that conforms to the
