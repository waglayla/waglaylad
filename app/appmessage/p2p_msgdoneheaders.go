...
// MsgDoneHeaders implements the Message interface and represents a waglayla
...
// NewMsgDoneHeaders returns a new waglayla DoneIBDBlocks message that conforms to the
// Message interface.
