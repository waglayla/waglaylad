...
// MsgRequestHeaders implements the Message interface and represents a waglayla
...
// NewMsgRequstHeaders returns a new waglayla RequestHeaders message that conforms to the
