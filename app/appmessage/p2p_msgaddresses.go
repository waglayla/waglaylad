...
// waglayla Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a waglayla
// Addresses message.
...
// NewMsgAddresses returns a new waglayla Addresses message that conforms to the
