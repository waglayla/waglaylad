...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a waglayla
...
// NewMsgDoneBlocksWithTrustedData returns a new waglayla DoneBlocksWithTrustedData message that conforms to the
// Message interface.
