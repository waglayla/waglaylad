...
// MsgRequestRelayBlocks implements the Message interface and represents a waglayla
...
// NewMsgRequestRelayBlocks returns a new waglayla RequestRelayBlocks message that conforms to
