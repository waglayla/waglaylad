...
// MsgRequestTransactions implements the Message interface and represents a waglayla
...
// NewMsgRequestTransactions returns a new waglayla RequestTransactions message that conforms to
